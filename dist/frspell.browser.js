(() => {
  ...
  var Yt = (t) => bf(Wn({}, "__esModule", { value: true }), t);
  var $r;
  var Et;
  var kt;
  var yf;
    ...
    Ua = (t, e) => {
      ...
      if (n != null) {
        ...
        for (let _ = 0; _ < i; _++) for (let S = 0; S < o; S++) {
          let x = (t.data[m++] - c[0]) * d[0], $ = (t.data[g++] - c[1]) * d[1], T = (t.data[y++] - c[2]) * d[2], I = b === -1 ? 255 : (t.data[b++] - c[3]) * d[3];
          n.fillStyle = "rgba(" + x + "," + $ + "," + T + "," + I + ")", n.fillRect(S, _, 1, 1);
        }
      ...
      if (r != null) {
        ...
        let g = 4, y = 0, b = 1, _ = 2, S = 3, x = 0, $ = m, T = m * 2, I = -1;
        u === "RGBA" ? (x = 0, $ = m, T = m * 2, I = m * 3) : u === "RGB" ? (x = 0, $ = m, T = m * 2) : u === "RBG" && (x = 0, T = m, $ = m * 2), n = r.createImageData(o, i);
        for (let A = 0; A < i * o; y += g, b += g, _ += g, S += g, A++) n.data[y] = (t.data[x++] - p[0]) * c[0], n.data[b] = (t.data[$++] - p[1]) * c[1], n.data[_] = (t.data[T++] - p[2]) * c[2], n.data[S] = I === -1 ? 255 : (t.data[I++] - p[3]) * c[3];
      } else throw new Error("Can not access image data");
      return n;
    };
  });
  ...
  var qa = V(() => {
    ...
    qn = (t, e) => {
      ...
      let u = e.format !== void 0 ? e.format : "RGBA", d = e.tensorFormat !== void 0 && e.tensorFormat !== void 0 ? e.tensorFormat : "RGB", c = r * n, p = d === "RGBA" ? new Float32Array(c * 4) : new Float32Array(c * 3), m = 4, g = 0, y = 1, b = 2, _ = 3, S = 0, x = c, $ = c * 2, T = -1;
      u === "RGB" && (m = 3, g = 0, y = 1, b = 2, _ = -1), d === "RGBA" ? T = c * 3 : d === "RBG" ? (S = 0, $ = c, x = c * 2) : d === "BGR" && ($ = 0, x = c, S = c * 2);
      for (let A = 0; A < c; A++, g += m, b += m, y += m, _ += m) p[S++] = (t[g] + s[0]) / i[0], p[x++] = (t[y] + s[1]) / i[1], p[$++] = (t[b] + s[2]) / i[2], T !== -1 && _ !== -1 && (p[T++] = (t[_] + s[3]) / i[3]);
  ...
  var Zn = {};
  Vt(Zn, { InferenceSession: () => _f, TRACE: () => Sr, TRACE_EVENT_BEGIN: () => _t, TRACE_EVENT_END: () => wt, TRACE_FUNC_BEGIN: () => Ve, TRACE_FUNC_END: () => Re, Tensor: () => je, env: () => _e, registerBackend: () => kt });
  var Le = V(() => {
    "use strict";
    za();
    Ra();
  ...
  async function cs(t = {}) {
    ...
    e.mountExternalData = (a, l) => {
      ...
      delete e.Xc;
    }, globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({ initial: 0, maximum: 0, Yd: true }).buffer.constructor;
    let i = (a) => async (...l) => {
      try {
...
`));
    ...
    var g, y, b, _, S, x, $ = console.log.bind(console), T = console.error.bind(console), I = $, A = T, E = false, z = (a) => a.startsWith("file://");
    function v() {
      ...
      let a = function(l) {
        try {
          ...
          if (f === "load") {
            ...
            }, C == "print" && (I = e[C]), C == "printErr" && (A = e[C]));
            ht = h.Od, Me(), y = h.Pd, be(), vr();
          } else if (f === "run") {
            (function(w) {
              var C = (v(), L)[w + 52 >>> 2 >>> 0];
          ...
          } else h.target !== "setimmediate" && (f === "checkMailbox" ? R && fr() : f && (A(`worker: received unknown command ${f}`), A(h)));
        } catch (w) {
          throw Ri(), w;
        }
      };
    ...
    var N, j, q, X, D, L, Q, Y, Z, te, ae, le = false;
    function Me() {
      var a = ht.buffer;
      e.HEAP8 = N = new Int8Array(a), q = new Int16Array(a), e.HEAPU8 = j = new Uint8Array(a), X = new Uint16Array(a), e.HEAP32 = D = new Int32Array(a), e.HEAPU32 = L = new Uint32Array(a), Q = new Float32Array(a), Y = new Float64Array(a), Z = new BigInt64Array(a), te = new BigUint64Array(a);
    }
    function ve() {
      le = true, o ? x() : ct.sb();
    }
    function M(a) {
      throw A(a = "Aborted(" + a + ")"), E = true, a = new WebAssembly.RuntimeError(a + ". Build with -sASSERTIONS for more info."), S?.(a), a;
    }
    function G() {
      return { a: { la: Am, gb: Cm, g: op, J: ip, f: ap, p: sp, h: up, ga: dp, b: lp, S: cp, Ha: Zo, n: pp, _: Jo, Xa: ei, Da: ti, Fa: ri, Ya: ni, Va: oi, Oa: ii, Ua: ai, ja: si, Ea: ui, Ba: di, Wa: li, Ca: ci, bb: mp, da: hp, wa: gp, ua: yp, ca: wp, O: vp, H: $p, va: xp, Z: kp, xa: Pp, Ra: Op, za: Dp, Ia: Bp, sa: Mp, ea: Rp, Qa: In, _a: Up, Q: Wp, r: Kp, c: Sn, hb: jp, y: Zp, M: Qp, D: Yp, l: Xp, s: _i, ib: Jp, I: em, R: tm, j: rm, u: nm, q: om, k: im, La: am, Ma: sm, Na: um, Ja: xi, Ka: Si, ta: Ti, db: lm, ab: mm, v: fm, $: hm, fa: gm, $a: cm, V: bm, Za: ym, Aa: _m, F: dm, T: wm, ka: _r, ya: $m, fb: vm, eb: xm, Sa: Ei, Ta: ki, Ga: _n, U: Pi, ia: Oi, Pa: zi, ha: Di, kb: cf, ma: af, lb: lf, na: of, G: jm, e: Om, t: km, w: Em, B: Wm, mb: tf, K: Fm, x: Bm, oa: rf, X: sf, aa: ef, nb: Jm, ob: Xm, qa: Zm, pa: Ym, pb: Qm, N: qm, Y: nf, d: Pm, A: Dm, m: zm, jb: pf, o: Rm, z: Um, C: Mm, E: Nm, L: Gm, qb: Km, P: uf, ba: Hm, W: df, rb: Lm, ra: Vm, i: Tm, a: ht, cb: dr } };
    }
    async function be() {
      function a(f, w) {
        var C = ct = f.exports;
    ...
    var _n = (a) => {
      ...
      var l = a.Rc;
      delete It[l], ft.push(a), Kt.splice(Kt.indexOf(a), 1), a.Rc = 0, Ni(l);
    };
    function Go() {
      Lo.forEach((a) => a());
    }
    var Ho = (a) => new Promise((l) => {
      a.onmessage = (w) => {
        var C = w.data;
        if (w = C.Sc, C.Zc && C.Zc != wr()) {
          var P = It[C.Zc];
          P ? P.postMessage(C, C.rd) : A(`Internal error! Worker sent a message "${w}" to target pthread ${C.Zc}, but that thread no longer exists!`);
        } else w === "checkMailbox" ? fr() : w === "spawnThread" ? qe(C) : w === "cleanupThread" ? mr(() => {
          Wo(It[C.Nd]);
        }) : w === "loaded" ? (a.loaded = true, l(a)) : C.target === "setimmediate" ? a.postMessage(C) : w === "uncaughtException" ? a.onerror(C.error) : w === "callHandler" ? e[C.wd](...C.args) : w && A(`worker sent an unknown command ${w}`);
      }, a.onerror = (w) => {
        throw A(`worker sent an error! ${w.filename}:${w.lineno}: ${w.message}`), w;
      };
      var h, f = [];
    ...
    function op(a) {
      var l = new wn(a >>>= 0);
      return (v(), N)[l.Tc + 12 >>> 0] == 0 && (qo(l, true), cr--), Ko(l, false), lr.push(l), Fi(a);
    }
    var Ut = 0, ip = () => {
      ce(0, 0);
      var a = lr.pop();
    ...
    var vn = (a) => {
      ...
      for (var w of a) {
        if (w === 0 || w === f) break;
        if (Hi(w, f, h.Tc + 16)) return Qt(w), l;
      }
      return Qt(f), l;
    };
    function ap() {
    ...
    var dp = () => {
      ...
      var l = a.cd;
      throw (v(), N)[a.Tc + 13 >>> 0] == 0 && (lr.push(a), Ko(a, true), qo(a, false), cr++), Rn(l), Ut = l;
    };
    function lp(a, l, h) {
      var f = new wn(a >>>= 0);
      throw l >>>= 0, h >>>= 0, (v(), L)[f.Tc + 16 >>> 2 >>> 0] = 0, (v(), L)[f.Tc + 4 >>> 2 >>> 0] = l, (v(), L)[f.Tc + 8 >>> 2 >>> 0] = h, Rn(a), cr++, Ut = a;
    }
    var cp = () => cr;
    function jo(a, l, h, f) {
    ...
    function xp(a, l) {
      lt(a >>>= 0, { name: l = Je(l >>> 0), Oc(h) {
        ...
        var C = w ? pr(f) : f.length, P = Zt(4 + C + 1), B = P + 4;
        return (v(), L)[P >>> 2 >>> 0] = C, w ? gt(f, B, C + 1) : (v(), j).set(f, B >>> 0), h !== null && h.push(tt, P), P;
      }, Uc: Tn, Wc(h) {
        tt(h);
      } });
    }
    ...
    function kp(a, l, h) {
      ...
      lt(a, { name: h, Oc: (P) => {
        ...
        var H = C(B), F = Zt(4 + H + l);
        return (v(), L)[F >>> 2 >>> 0] = H / l, w(B, F + 4, H + l), P !== null && P.push(tt, F), F;
      }, Uc: Tn, Wc(P) {
        tt(P);
      } });
    }
    ...
    function In(a) {
      a >>>= 0, zp || (Atomics.waitAsync((v(), D), a >>> 2, a).value.then(fr), a += 128, Atomics.store((v(), D), a >>> 2, 1));
    }
    var fr = () => mr(() => {
      var a = wr();
      a && (In(a), Li());
    ...
    function Dp(a, l) {
      (a >>>= 0) == l >>> 0 ? setTimeout(fr) : o ? postMessage({ Zc: a, Sc: "checkMailbox" }) : (a = It[a]) && a.postMessage({ Sc: "checkMailbox" });
    }
    var Cn = [];
    ...
    function Np(a) {
      var l = (...h) => {
        ...
        try {
          ...
          E || (gr.pop(), et && bt === 1 && gr.length === 0 && (bt = 0, Ne += 1, hr(Ea), typeof Fibers < "u" && Fibers.$d()));
        }
      };
      return bi.set(a, l), l;
    }
    var bt = 0, et = null, hi = 0, gr = [], An = /* @__PURE__ */ new Map(), gi = /* @__PURE__ */ new Map(), bi = /* @__PURE__ */ new Map(), Vp = 0, En = null, Lp = [], yi = (a) => (function(l) {
      if (!E) {
        if (bt === 0) {
          var h = false, f = false;
          l((w = 0) => {
            if (!E && (hi = w, h = true, f)) {
              bt = 2, hr(() => ka(et)), typeof MainLoop < "u" && MainLoop.ud && MainLoop.resume(), w = false;
              try {
                var C = (function() {
                  var H = (v(), D)[et + 8 >>> 2 >>> 0];
            ...
            var w = Zt(65548), C = w + 12;
            if ((v(), L)[w >>> 2 >>> 0] = C, (v(), L)[w + 4 >>> 2 >>> 0] = C + 65536, C = gr[0], !An.has(C)) {
              var P = Vp++;
              An.set(C, P), gi.set(P, C);
            }
            return C = An.get(C), (v(), D)[w + 8 >>> 2 >>> 0] = C, w;
          })(), typeof MainLoop < "u" && MainLoop.ud && MainLoop.pause(), hr(() => Aa(et)));
        } else bt === 2 ? (bt = 0, hr(Pa), tt(et), et = null, Lp.forEach(mr)) : M(`invalid state: ${bt}`);
        return hi;
      }
    })((l) => {
      a().then(l);
    ...
    function Kp(a, l, h) {
      ...
      switch (a = C.map((H, F) => {
        ...
        case 3:
          ...
          break;
        case 1:
          P.getStringOrSymbol = br, B = "toValue(handle)[getStringOrSymbol(methodName)]";
      }
  ...
  ${B}
    ...
    function Zp(a) {
      return (a >>>= 0) ? (a = br(a), Ke(globalThis[a])) : Ke(globalThis);
    }
    function Qp(a) {
      return a = br(a >>> 0), Ke(e[a]);
    }
    function Yp(a, l) {
    ...
    var jt = {}, dm = () => performance.timeOrigin + performance.now();
    function Ti(a, l) {
    ...
    var wm = () => navigator.hardwareConcurrency, At = {}, yr = (a) => {
      var l;
      return (l = /\bwasm-function\[\d+\]:(0x[0-9a-f]+)/.exec(a)) ? +l[1] : (l = /:(\d+):\d+(?:\)|$)/.exec(a)) ? 2147483648 | +l[1] : 0;
    }, Ci = (a) => {
      for (var l of a) (a = yr(l)) && (At[a] = l);
    };
    function vm() {
      var a = Error().stack.toString().split(`
`);
      return a[0] == "Error" && a.shift(), Ci(a), At.gd = yr(a[3]), At.Jd = a, At.gd;
    }
    function _r(a) {
      ...
      tt(_r.hd ?? 0), l = pr(a) + 1;
      var h = Zt(l);
      return h && gt(a, h, l), _r.hd = h, _r.hd;
    }
    function $m(a) {
      a >>>= 0;
      var l = (v(), j).length;
...
`))[0] == "Error" && f.shift(), Ci(f);
      for (var w = 3; f[w] && yr(f[w]) != a; ) ++w;
      for (a = 0; a < h && f[a + w]; ++a) (v(), D)[l + 4 * a >>> 2 >>> 0] = yr(f[a + w]);
      return a;
    }
    var On, zn = {}, Ai = () => {
      if (!On) {
    ...
    function ki(a, l) {
      ...
      a >>>= 0, l >>>= 0;
      var h = Ai();
      for (var f of ((v(), L)[a >>> 2 >>> 0] = h.length, a = 0, h)) a += pr(f) + 1;
    ...
    function Di(a, l, h, f) {
      ...
      for (var w = 0, C = 0; C < h; C++) {
        ...
        l += 8;
        for (var H = 0; H < B; H++) {
          var F = a, se = (v(), j)[P + H >>> 0], pe = Sm[F];
          se === 0 || se === 10 ? ((F === 1 ? I : A)(Xo(pe)), pe.length = 0) : pe.push(se);
        }
        w += B;
      }
    ...
    var Bi, Mi, wr, tt, Zt, Dn, Ri, Ui, Ni, Bn, Vi, Li, ce, Qt, Wi, ue, Mn, de, Gi, Rn, Hi, Fi, qi, Un, Ki, ji, Zi, Qi, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, ct, Im = [dr, Vo, jo, Jo, ei, ti, ri, ni, oi, ii, ai, si, ui, di, li, ci, xi, Si, Ti, Ei, ki, Pi, Oi, zi, Di], Nn = { 958812: (a, l, h, f, w) => {
      ...
      e.td(a, (v(), j).subarray(l >>> 0, l + h >>> 0));
    }, 959700: () => e.Wd(), 959742: (a) => {
      e.sd(a);
    }, 959779: () => {
      e.Bd();
    }, 959810: () => {
      ...
      e.Gd();
    }, 959864: (a) => e.Ad(a), 959897: (a) => e.Ed(a), 959929: (a, l, h) => {
      e.ed(Number(a), Number(l), Number(h), true);
    }, 959992: (a, l, h) => {
      e.ed(Number(a), Number(l), Number(h));
    }, 960049: () => typeof wasmOffsetConverter < "u", 960106: (a) => {
      e.$b("Abs", a, void 0);
    }, 960157: (a) => {
      e.$b("Neg", a, void 0);
    }, 960208: (a) => {
      ...
      e.$b("DepthToSpace", a, { blocksize: l, mode: Ae(h), format: f ? "NHWC" : "NCHW" });
    }, 964594: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie, yt) => {
      e.$b("ConvTranspose", a, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [w], pads: [C, P], strides: [B], wIsConst: () => !!(v(), N)[F >>> 0], outputPadding: se ? Array.from((v(), D).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((v(), D).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ae(yt) });
    }, 965027: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
    ...
    }, 965688: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie, yt) => {
      e.$b("ConvTranspose", a, { format: H ? "NHWC" : "NCHW", autoPad: l, dilations: [h], group: f, kernelShape: [w], pads: [C, P], strides: [B], wIsConst: () => !!(v(), N)[F >>> 0], outputPadding: se ? Array.from((v(), D).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [], outputShape: xe ? Array.from((v(), D).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [], activation: Ae(yt) });
    }, 966121: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
      e.$b("ConvTranspose", a, { format: B ? "NHWC" : "NCHW", autoPad: l, dilations: Array.from((v(), D).subarray(Number(h) >>> 0, 2 + (Number(h) >>> 0) >>> 0)), group: f, kernelShape: Array.from((v(), D).subarray(Number(w) >>> 0, 2 + (Number(w) >>> 0) >>> 0)), pads: Array.from((v(), D).subarray(Number(C) >>> 0, 4 + (Number(C) >>> 0) >>> 0)), strides: Array.from((v(), D).subarray(Number(P) >>> 0, 2 + (Number(P) >>> 0) >>> 0)), wIsConst: () => !!(v(), N)[H >>> 0], outputPadding: F ? Array.from((v(), D).subarray(Number(F) >>> 0, Number(se) >>> 0)) : [], outputShape: pe ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [], activation: Ae(Ie) });
    }, 966782: (a, l) => {
      e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
    }, 966873: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
      ...
      e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
    }, 967443: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
      e.$b("AveragePool", a, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: w, dilations: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: B ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], pads: F ? Array.from((v(), D).subarray(Number(F) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
    }, 967922: (a, l) => {
      e.$b("GlobalMaxPool", a, { format: l ? "NHWC" : "NCHW" });
    }, 968009: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
      ...
      e.$b("GlobalMaxPool", a, { format: l ? "NHWC" : "NCHW" });
    }, 968571: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie) => {
      e.$b("MaxPool", a, { format: Ie ? "NHWC" : "NCHW", auto_pad: l, ceil_mode: h, count_include_pad: f, storage_order: w, dilations: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], kernel_shape: B ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], pads: F ? Array.from((v(), D).subarray(Number(F) >>> 0, Number(se) >>> 0)) : [], strides: pe ? Array.from((v(), D).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [] });
    }, 969046: (a, l, h, f, w) => {
    ...
    }, 969982: (a, l, h, f, w, C, P, B, H, F, se) => {
      e.$b("Resize", a, { antialias: l, axes: h ? Array.from((v(), D).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], coordinateTransformMode: Ae(w), cubicCoeffA: C, excludeOutside: P, extrapolationValue: B, keepAspectRatioPolicy: Ae(H), mode: Ae(F), nearestMode: Ae(se) });
    }, 970344: (a, l, h, f, w, C, P) => {
    ...
    }, 972559: (a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie, yt, Vn) => {
      e.$b("Conv", a, { format: pe ? "NHWC" : "NCHW", auto_pad: l, dilations: h ? Array.from((v(), D).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [], group: w, kernel_shape: C ? Array.from((v(), D).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [], pads: B ? Array.from((v(), D).subarray(Number(B) >>> 0, Number(H) >>> 0)) : [], strides: F ? Array.from((v(), D).subarray(Number(F) >>> 0, Number(se) >>> 0)) : [], w_is_const: () => !!(v(), N)[Number(xe) >>> 0], activation: Ae(Ie), activation_params: yt ? Array.from((v(), Q).subarray(Number(yt) >>> 0, Number(Vn) >>> 0)) : [] });
    }, 973143: (a) => {
      e.$b("Gelu", a, void 0);
    }, 973195: (a, l, h, f, w, C, P, B, H) => {
      ...
      e.Fd(a);
    }, 974482: (a, l) => e.Hd(Number(a), Number(l), e.Yc.Kd, e.Yc.errors) };
    function Cm(a, l, h) {
      return yi(async () => {
    ...
    function Hm(a, l, h, f, w, C, P, B, H, F, se, pe) {
      var xe = de();
      try {
        ia(a, l, h, f, w, C, P, B, H, F, se, pe);
      } catch (Ie) {
        if (ue(xe), Ie !== Ie + 0) throw Ie;
        ce(1, 0);
      }
    }
    function Fm(a, l, h, f, w, C) {
      var P = de();
      try {
    ...
    function Km(a, l, h, f, w, C, P, B, H) {
      var F = de();
      try {
        Yi(a, l, h, f, w, C, P, B, H);
      } catch (se) {
        if (ue(F), se !== se + 0) throw se;
        ce(1, 0);
      }
    }
    function jm(a) {
    ...
    function sf(a, l, h, f, w, C, P, B, H, F, se, pe) {
      var xe = de();
      try {
        return Ia(a, l, h, f, w, C, P, B, H, F, se, pe);
      } catch (Ie) {
        if (ue(xe), Ie !== Ie + 0) throw Ie;
        ce(1, 0);
      }
    }
    function uf(a, l, h, f, w, C, P, B, H, F, se) {
      var pe = de();
      try {
        ba(a, l, h, f, w, C, P, B, H, F, se);
      } catch (xe) {
        if (ue(pe), xe !== xe + 0) throw xe;
        ce(1, 0);
      }
    }
    function df(a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie, yt, Vn) {
      var mf = de();
      try {
        ya(a, l, h, f, w, C, P, B, H, F, se, pe, xe, Ie, yt, Vn);
      } catch (Ln) {
    ...
    function vr() {
      if (0 < he) Te = vr;
        ...
        0 < he ? Te = vr : (e.calledRun = true, E || (ve(), _?.(e)));
      }
    }
    return o || (ct = await be(), vr()), e.PTR_SIZE = 4, le ? e : new Promise((a, l) => {
      _ = a, S = l;
    });
  }
  var vf;
  ...
  var Cr = V(() => {
    "use strict";
    Ir();
    gs = typeof location > "u" ? void 0 : location.origin, Xn = import_meta.url > "file:" && import_meta.url < "file;", xf = () => {
      if (true) {
        if (Xn) {
          let t = URL;
          return new URL(new t("ort.bundle.min.mjs", import_meta.url).href, gs).href;
        }
  ...
  var vt = V(() => {
    ...
    eo = false, Mr = false, vs = false, Cf = () => {
      ...
      if (e > 0 && b.push(new Promise((_) => {
        ...
        g(x).then(($) => {
          Mr = false, eo = true, Jn = $, _(), m && URL.revokeObjectURL(m);
        }, ($) => {
          Mr = false, vs = true, S($);
        });
  ...
  var xs = V(() => {
    ...
    $s = (t) => {
      ...
      try {
        ...
        let i = 0;
        return t?.tag !== void 0 && (i = Ge(t.tag, n)), r = e._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && me("Can't create run options."), t?.extra !== void 0 && er(t.extra, "", /* @__PURE__ */ new WeakSet(), (s, u) => {
  ...
  fn o2i_${t}(offset: u32) -> ${g.indices} {
    ...
    ${$}
    return indices;
  }`, I = (M) => (b.offsetToIndices = true, s < 2 ? M : `o2i_${t}(${M})`), A = [];
      if (s >= 2) for (let M = s - 1; M >= 0; M--) A.push(`${K(x, M, s)} * (indices[${M}])`);
      let E = s < 2 ? "" : `
  fn i2o_${t}(indices: ${g.indices}) -> u32 {
    return ${A.join("+")};
  }`, z = (M) => (b.indicesToOffset = true, s < 2 ? M : `i2o_${t}(${M})`), v = (...M) => s === 0 ? "0u" : `${g.indices}(${M.map(y).join(",")})`, R = (M, G) => s < 2 ? `${M}` : `${K(M, G, s)}`, N = (M, G, be) => s < 2 ? `${M}=${be};` : `${K(M, G, s)}=${be};`, j = {}, q = (M, G) => {
        b.broadcastedIndicesToOffset = true;
        let be = `${G.name}broadcastedIndicesTo${t}Offset`;
        if (be in j) return `${be}(${M})`;
        let Ee = [];
        for (let $e = s - 1; $e >= 0; $e--) {
          let Pe = G.indicesGet("outputIndices", $e + G.rank - s);
          Ee.push(`${R(x, $e)} * (${Pe} % ${R(S, $e)})`);
        }
        return j[be] = `fn ${be}(outputIndices: ${G.type.indices}) -> u32 {
  ...
  fn set_${t}(${M}, value: ${p}) {
    set_${t}ByIndices(${v(G)}, value);
      ...
      return { impl: () => {
        let M = [], G = false;
        return b.offsetToIndices && (M.push(T), G = true), b.indicesToOffset && (M.push(E), G = true), b.broadcastedIndicesToOffset && (Object.values(j).forEach((be) => M.push(be)), G = true), b.set && (M.push(ae), G = true), b.setByIndices && (M.push(te), G = true), b.get && (M.push(Q), G = true), b.getByIndices && (M.push(L), G = true), !i && G && M.unshift(`const ${S} = ${g.indices}(${r.join(",")});`, `const ${x} = ${g.indices}(${k.computeStrides(r).join(",")});`), M.join(`
`);
      ...
      }, setByOffset: X, setByIndices: (M, G) => s < 2 ? X(M, G) : (b.setByIndices = true, b.indicesToOffset = true, `set_${t}ByIndices(${M}, ${G});`), get: Y, getByOffset: D, getByIndices: Z, usage: n, name: t, strides: x, shape: S, rank: s };
...
`);
  ...
  var pt = V(() => {
    ...
    var a: ${r.type.indices};`;
      ...
      if (d) return c = (_) => {
        let S = O("input", r, s, 4), x = U("output", r, u, 4);
        return `
  ...
  ${S.mainStart([_, _, 1])}
    ...
    if (output_row < uniforms.output_shape[0] && output_col < uniforms.output_shape[1]) {
      ${$.setByIndices(`${$.type.indices}(output_row, output_col)`, "tile[local_id.x][local_id.y]")}
          ...
          let S = k.size(i);
          return { outputs: [{ dims: i, dataType: t.dataType }], dispatchGroup: { x: Math.ceil(u[1] / _), y: Math.ceil(u[0] / _) }, programUniforms: [{ type: 12, data: S }, ...W(s, u)] };
        }, getShaderSource: c };
      }
      return c = (_) => {
        let S = O("a", r, s.length), x = U("output", r, u.length);
        return `
  ${_.registerUniform("output_size", "u32").declareVariables(S, x)}
  ...
  var Yr = V(() => {
    ...
    at = (t) => {
      ...
      return { name: t, shaderCache: e, getShaderSource: (S) => {
        let x = [], $ = O("_A", r[0].dataType, p), T = U("output", i, y), I = n($, T, m), A = I[2];
        for (let E = 0, z = 0; E < p; E++) g || m.indexOf(E) >= 0 ? (s && z++, A = `for(var j${E}: u32 = 0; j${E} < ${c[E]}; j${E}++) {
                  ${I[2].includes("last_index") ? `let last_index = j${E};` : ""}
                  ${$.indicesSet("input_indices", E, `j${E}`)}
                  ${A}
                }`) : (x.push(`${$.indicesSet("input_indices", E, T.indicesGet("output_indices", z))};`), z++);
        return `
...
var best_index : i32 = 0;`, `if (${n.getByIndices("input_indices")} ${e.selectLastIndex > 0 ? ">=" : ">"} value) {
  ...
  var Jr = V(() => {
    ...
    `, hh = (t, e, r, n, o, i, s, u) => {
      ...
      let S = (x) => {
        let $ = U("x", t.dataType, t.dims, d), T = [$], I = s ? O("seq_lens", s.dataType, s.dims) : void 0;
        I && T.push(I);
        let A = u ? O("total_sequence_length_input", u.dataType, u.dims) : void 0;
        A && T.push(A);
        let E = ze(t.dataType), z = [{ name: "batch_size", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "past_sequence_length", type: "u32" }, { name: "sequence_length", type: "u32" }, { name: "total_sequence_length", type: "u32" }, { name: "elements_per_thread", type: "u32" }];
        return `
  ...
  ${x.mainStart([c, 1, 1])}
    ...
    if (sum == 0) {
      ...
      let v = (R) => {
        ...
        m && Q.push(U("present_key", e.dataType, y, S));
        let Y = ze(1, S), Z = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "alpha", type: "f32" }, { name: "past_sequence_length", type: "u32" }, { name: "kv_sequence_length", type: "u32" }, { name: "n_reps", type: "u32" }];
        return `
  const TILE_SIZE = ${$}u;
  ...
  ${R.mainStart([$, $, 1])}
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      return { name: "AttentionProbs", shaderCache: { hint: `${S};${o !== void 0};${n !== void 0};${t}`, inputDependencies: E }, getRunData: () => ({ outputs: z, dispatchGroup: T, programUniforms: I }), getShaderSource: v };
      ...
      let A = (E) => {
        ...
        s && R.push(N);
        let j = u ? O("total_sequence_length_input", u.dataType, u.dims) : void 0;
        u && R.push(j);
  ...
  ${E.mainStart([_, _, 1])}
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
      ...
      return { name: "AttentionScore", shaderCache: { hint: `${n !== void 0};${t}`, inputDependencies: T }, getRunData: () => ({ outputs: I, dispatchGroup: S, programUniforms: x }), getShaderSource: A };
    }, Wt = (t, e, r, n, o, i, s, u, d, c, p = void 0, m = void 0) => {
      let g = Math.min(t.outputCount, 1 + (s ? 1 : 0) + (u ? 1 : 0)), y = g > 1 ? c.pastSequenceLength : 0, b = y + c.kvSequenceLength, _ = d && k.size(d.dims) > 0 ? d : void 0, S = [e, r];
      g > 1 && s && k.size(s.dims) > 0 && S.push(s), _ && S.push(_), p && S.push(p), m && S.push(m);
      let x = t.compute(gh(g, e, r, s, _, c, y, p, m), { inputs: S, outputs: g > 1 ? [-1, 1] : [-1] })[0];
      t.compute(hh(x, c.batchSize, c.numHeads, y, c.sequenceLength, b, p, m), { inputs: p && m ? [x, p, m] : [x], outputs: [] });
      let $ = [x, n];
      g > 1 && u && k.size(u.dims) > 0 && $.push(u), p && $.push(p), m && $.push(m), t.compute(bh(g, x, n, u, c, y, p, m), { inputs: $, outputs: g > 1 ? [0, 2] : [0] });
    }, yh = (t, e) => {
      let r = [e.batchSize, e.numHeads, e.sequenceLength, e.headSize], n = e.sequenceLength, o = e.inputHiddenSize, i = e.headSize, s = 12, u = { x: Math.ceil(e.headSize / s), y: Math.ceil(e.sequenceLength / s), z: e.batchSize * e.numHeads }, d = [t.inputs[0], t.inputs[1], t.inputs[2]], c = [{ type: 12, data: n }, { type: 12, data: o }, { type: 12, data: i }, { type: 12, data: e.numHeads }, { type: 12, data: e.headSize }, { type: 12, data: e.hiddenSize }, { type: 12, data: e.hiddenSize + e.hiddenSize + e.vHiddenSize }], p = (m) => {
        let g = U("output_q", d[0].dataType, r), y = U("output_k", d[0].dataType, r), b = U("output_v", d[0].dataType, r), _ = O("input", d[0].dataType, d[0].dims), S = O("weight", d[1].dataType, d[1].dims), x = O("bias", d[2].dataType, d[2].dims), $ = _.type.storage, T = [{ name: "M", type: "u32" }, { name: "K", type: "u32" }, { name: "N", type: "u32" }, { name: "num_heads", type: "u32" }, { name: "head_size", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "ldb", type: "u32" }];
        return `
  const TILE_SIZE = ${s}u;
  ...
  var wu = V(() => {
    ...
    _h = (t, e) => {
      ...
      let { epsilon: r, spatial: n, format: o } = e, i = t[0].dims, s = n ? fe(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? s : 1, d = k.size(i) / s, c = n, p = c ? i.length : i, m = O("x", t[0].dataType, t[0].dims, s), g = O("scale", t[1].dataType, t[1].dims, u), y = O("bias", t[2].dataType, t[2].dims, u), b = O("inputMean", t[3].dataType, t[3].dims, u), _ = O("inputVar", t[4].dataType, t[4].dims, u), S = U("y", t[0].dataType, p, s), x = () => {
        let T = "";
...
`, Ch = (t) => `quick_gelu_impl(${t})`, od = (t, e) => {
  ...
  var yd = V(() => {
    ...
    kh = (t, e, r, n, o, i, s, u, d, c, p, m) => {
      let g, y;
      typeof u == "string" ? g = y = ($, T) => `${u}((${$}),(${T}))` : typeof u == "function" ? g = y = u : (g = u.scalar, y = u.vector);
      let b = U("outputData", p, n.length, 4), _ = O("aData", d, e.length, 4), S = O("bData", c, r.length, 4), x;
      if (o) if (i) {
        let $ = k.size(e) === 1, T = k.size(r) === 1, I = e.length > 0 && e[e.length - 1] % 4 === 0, A = r.length > 0 && r[r.length - 1] % 4 === 0;
        $ || T ? x = b.setByOffset("global_idx", y($ ? `${_.type.value}(${_.getByOffset("0")}.x)` : _.getByOffset("global_idx"), T ? `${S.type.value}(${S.getByOffset("0")}.x)` : S.getByOffset("global_idx"))) : x = `
          ...
          `;
      } else x = b.setByOffset("global_idx", y(_.getByOffset("global_idx"), S.getByOffset("global_idx")));
      else {
        if (!i) throw new Error("no necessary to use scalar implementation for element-wise binary op implementation.");
        let $ = (T, I, A = "") => {
          let E = `aData[indexA${I}][componentA${I}]`, z = `bData[indexB${I}][componentB${I}]`;
          return `
      ...
      if (c) {
        ...
        b.push(S), b.push(x), b.push($), b.push(T);
        let I = 1;
        for (let A = 1; A < p.length; A++) {
          let E = u[u.length - A], z = d[d.length - A];
          if (E === z) I *= E;
          else break;
        }
        I % 4 === 0 ? (y = true, g = true) : (S || x || $ || T) && (g = true);
      } else g = true;
...
`);
  ...
  ${(() => {
        ...
        for (let S = 0; S < t.length; S++) _.registerUniform(`sizeInConcatAxis${S}`, "u32");
...
`;
      ...
      let s = t[0].dims, u = t[1].dims, d = s[s.length - 2], c = u[u.length - 1], p = s[s.length - 1], m = fe(c), g = fe(p), y = fe(d), b = k.size(r) / m / y, _ = t.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), $ = [k.size(S), d, c], T = [{ type: 12, data: b }, { type: 12, data: d }, { type: 12, data: c }, { type: 12, data: p }];
      Ye(e, T), T.push(...W(S, s, u)), _ && T.push(...W(t[2].dims)), T.push(...W($));
      let I = (A) => {
        let E = Qr("batch_dims", t[0].dataType, S.length), z = O("a", t[0].dataType, s.length, g), v = O("b", t[1].dataType, u.length, m), R = U("output", t[0].dataType, $.length, m), N = we(R.type.tensor), j = Qe(e, R.type.value, N), q = [z, v], X = "";
        if (_) {
          let Q = o ? m : 1;
...
`;
  ...
  `;
      ...
      return { name: "MatMulNaive", shaderCache: { hint: `${e.activation};${m};${g};${y};${o}`, inputDependencies: _ ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: Math.ceil(b / 64) }, programUniforms: T }), getShaderSource: I };
    };
  });
  var Rh;
  var Uh;
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      ...
      let y = g / e[1], b = m / e[0], _ = i / e[1], S = d ? `
    let localRow = i32(localId.y);
...
`;
    ...
    `;
      ...
      Ye(e, R), R.push(...W(p, I, E));
      let N = ["rank", "rank"], j = t.length > 2;
      j && (R.push(...W(t[2].dims)), N.push("rank")), R.push(...W(v));
      let q = (X) => {
        let D = p.length, L = Qr("batchDims", t[0].dataType, D, 1), Q = we(t[0].dataType), Y = O("a", t[0].dataType, A, T), Z = O("b", t[1].dataType, z, T), te = U("result", t[0].dataType, v.length, T), ae = [Y, Z];
        if (j) {
          let G = o ? T : 1;
        ...
        Xe(e, le);
        let Me = we(te.type.tensor), ve = Qe(e, te.type.value, Me), M = Vh(T, j, ve, [L, Y, Z, te], o);
        return `
  ...
  ${_ ? vo(S, x, Q, L) : $o(S, x, Q, L)}
      ...
      return { name: "MatMul", shaderCache: { hint: `${S};${e.activation};${_};${o}`, inputDependencies: N }, getRunData: () => ({ outputs: [{ dims: i ? i(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: $[0], y: $[1], z: $[2] }, programUniforms: R }), getShaderSource: q };
    };
  });
  var Lh;
  var Id;
  var Cd = V(() => {
    ...
    return ${ke(u, c)}(0.0);`, A = ke(d, c), E = t ? ke(s, c) : ke(u, c), z = t ? ke(u, c) : ke(s, c), v = Qe(i, A, c);
      return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${A}) {
      ...
      let c = e.format === "NHWC", p = c ? t[0].dims[3] : t[0].dims[1], m = r[0], g = c ? r[2] : r[3], y = c ? r[1] : r[2], b = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && b % 4 === 0, S = c ? b : g * y, x = c ? g * y : b, $ = [8, 8, 1], T = n <= 8 ? [4, 1, 1] : [4, 4, 1], I = [Math.ceil(S / $[0] / T[0]), Math.ceil(x / $[1] / T[1]), Math.ceil(m / $[2] / T[2])];
      ie("verbose", () => `[conv2d_mm_webgpu] dispatch = ${I}`);
      let A = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, E = $[1] * T[1], z = $[0] * T[0], v = Math.max($[0] * A, $[1]), R = n % E === 0, N = o % z === 0, j = i % v === 0, q = _ ? [A, 4, 4] : [1, 1, 1], X = [{ type: 6, data: n }, { type: 6, data: o }, { type: 6, data: i }, { type: 6, data: [e.pads[0], e.pads[1]] }, { type: 6, data: e.strides }, { type: 6, data: e.dilations }];
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${te}>` : te}) {
      ...
      }`, le = O("x", t[0].dataType, t[0].dims.length, A === 3 ? 1 : A), Me = O("w", t[1].dataType, t[1].dims.length, Z), ve = [le, Me], M = U("result", t[0].dataType, r.length, Z);
        if (s) {
        ...
        ${_ ? vo(T, $, te, void 0, !c, v) : $o(T, $, te, void 0, !c, v, false, void 0, u)}`;
      };
      return { name: "Conv2DMatMul", shaderCache: { hint: `${e.cacheKey};${A};${_};${R};${N};${j};${E};${z};${v}`, inputDependencies: D }, getRunData: () => ({ outputs: [{ dims: d ? d(r) : r, dataType: t[0].dataType }], dispatchGroup: { x: I[0], y: I[1], z: I[2] }, programUniforms: X }), getShaderSource: L };
    };
  });
  var Wh;
  var Ad;
  ...
  var Od = V(() => {
    ...
    Wh = (t) => {
      ...
      if (t === "VALID" && (t = 0), typeof t == "number") {
        ...
        if (!t.every((_, S, x) => _ === x[0])) throw Error(`Unsupported padding parameter: ${t}`);
        ...
        let b = (m - 1) * o + u - e, _ = (g - 1) * i + d - r, S = (y - 1) * s + c - n, x = Math.floor(b / 2), $ = b - x, T = Math.floor(_ / 2), I = _ - T, A = Math.floor(S / 2), E = S - A;
        p = { top: T, bottom: I, left: A, right: E, front: x, back: $ };
      ...
      let [g, , y, b, _] = e, [S, x, $] = Ad(r), [T, I, A] = Ad(n), E = un(y, T), z = un(b, I), v = un(_, A), { padInfo: R, outDepth: N, outHeight: j, outWidth: q } = Hh(o, d, c, p, S, x, $, E, z, v), X = i ? g * m : g, D = [0, 0, 0, 0, 0];
      return s === "channelsFirst" ? D = [u, X, N, j, q] : s === "channelsLast" && (D = [u, N, j, q, X]), { batchSize: u, dataFormat: s, inDepth: d, inHeight: c, inWidth: p, inChannels: m, outDepth: N, outHeight: j, outWidth: q, outChannels: X, padInfo: R, strideDepth: S, strideHeight: x, strideWidth: $, filterDepth: y, filterHeight: b, filterWidth: _, effectiveFilterDepth: E, effectiveFilterHeight: z, effectiveFilterWidth: v, dilationDepth: T, dilationHeight: I, dilationWidth: A, inShape: t, outShape: D, filterShape: e };
    }, Pd = (t, e, r, n, o, i) => {
      let s = i === "channelsLast", u = s ? t[0].dims[3] : t[0].dims[1], d = false, c = [64, 1, 1], p = { x: r.map(($, T) => T) }, m = [Math.ceil(Wh(p.x.map(($) => r[$])) / c[0]), 1, 1];
      ...
      let _ = ["rank", "rank"], S = t.length === 3;
      S && (b.push(...W(t[2].dims)), _.push("rank")), b.push(...W(r));
      let x = ($) => {
        ...
        Xe(e, T);
        let I = d ? 4 : 1, A = we(t[0].dataType), E = O("x", t[0].dataType, t[0].dims.length, g === 3 ? 1 : g), z = O("W", t[1].dataType, t[1].dims.length, I), v = [E, z], R = U("result", t[0].dataType, r.length, I), N = "";
        if (S) {
      ...
      return { name: "Conv3DNaive", shaderCache: { hint: `${e.cacheKey};${s};${g};${S}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: r, dataType: t[0].dataType }], dispatchGroup: { x: m[0], y: m[1], z: m[2] }, programUniforms: b }), getShaderSource: x };
    };
  });
  var zd;
  var Dd;
  var Bd = V(() => {
    ...
    zd = (t, e, r, n) => {
      ...
      let _ = (S) => {
        let x = U("output", t[0].dataType, r.length, m), $ = we(x.type.tensor), T = Qe(e, x.type.value, $), I = O("x", t[0].dataType, s.length), A = O("w", t[1].dataType, u.length, m), E = [I, A];
        o && E.push(O("b", t[2].dataType, t[2].dims, m));
  ...
  ${S.mainStart()}
    ...
    ${x.setByOffset("global_idx", "value")}
      ...
      let g = (s - 1) * e.strides[1] + c[1], y = (b) => {
        let _ = U("output", t[0].dataType, p.length, i), S = we(_.type.tensor), x = Qe(e, _.type.value, S), $ = O("x", t[0].dataType, d.length, i), T = O("w", t[1].dataType, c.length, i), I = [$, T];
        o && I.push(O("b", t[2].dataType, t[2].dims, i));
        let A = o ? "value += b[output_channel];" : "", E = [{ name: "output_size", type: "u32" }, { name: "strides", type: "i32", length: 2 }, { name: "pads", type: "i32", length: 2 }];
        return Xe(e, E), `
    ...
    Fh = (t, e, r, n, o, i) => {
      ...
      if (r.group !== 1) {
        ...
        if (o) {
          ...
          r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = v), E.push(v);
        } else E.push(e[1]);
        e.length === 3 && E.push(e[2]), !t.adapterInfo.isArchitecture("ampere") && o && e[1].dims[0] === r.group && e[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? t.compute(Dd(E, r, i, n), { inputs: E }) : t.compute(zd(E, r, i, n), { inputs: E });
        return;
      }
      ...
      if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
        ...
        if (o) {
          ...
          if (r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = X), _) {
            let D = u * d * c;
            z = e[0].reshape([1, E, D]), v = X.reshape([1, D, b]), R = [1, E, b];
          } else z = e[0].reshape([E, u * d, c]), v = X.reshape([1, c, b]), R = [E, g * y, b];
          N.push(z), N.push(v);
        } else z = e[0].reshape([E, c, u * d]), v = e[1].reshape([1, b, c]), R = [E, b, g * y], N.push(v), N.push(z);
        s && N.push(e[2]);
        let j = R[2], q = N[0].dims[N[0].dims.length - 1];
        j < 8 && q < 8 ? t.compute(on(N, r, i, R, o, n), { inputs: N }) : t.compute(ir(N, r, i, R, o, n), { inputs: N });
        return;
      }
      let S = true, x = t.kernelCustomData.wT ?? t.compute(De(e[1], xo), { inputs: [1], outputs: [r.wIsConst ? -2 : -1] })[0];
      r.wIsConst && !t.kernelCustomData.wT && (t.kernelCustomData.wT = x);
      let $ = [e[0], x];
      s && $.push(e[2]);
      let T = o ? g * y : b, I = o ? b : g * y, A = p * m * c;
      t.compute(Id($, r, i, T, I, A, s, S, n), { inputs: $ });
    }, Kh = (t, e) => {
  ...
  var Nd = V(() => {
    ...
    oe();
    Ud = (t, e, r) => {
      let n = t.length > 2, o = e.outputShape, i = e.format === "NHWC", s = e.group, u = t[1].dims, d = u[2] / s, c = u[3], p = i ? fe(d) : 1, m = i && c === 1 && d >= 4, g = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, y = d - g, b = i ? fe(c) : 1, _ = i ? c === 1 ? p : b : 1, S = k.size(o) / b, x = [Math.ceil(S / 64), 1, 1];
      ie("verbose", () => `[conv2d_backprop_webgpu] dispatch = ${x}`);
      let $ = ["rank", "rank"], T = [e.strides[0], e.strides[1]], I = [e.kernelShape[i ? 1 : 2], e.kernelShape[i ? 2 : 3]], A = [e.dilations[0], e.dilations[1]], E = [I[0] + (e.dilations[0] <= 1 ? 0 : (e.kernelShape[i ? 1 : 2] - 1) * (e.dilations[0] - 1)), I[1] + (e.dilations[1] <= 1 ? 0 : (e.kernelShape[i ? 2 : 3] - 1) * (e.dilations[1] - 1))], z = [E[0] - 1 - Math.floor((e.pads[0] + e.pads[2]) / 2), E[1] - 1 - Math.floor((e.pads[1] + e.pads[3]) / 2)], v = [{ type: 12, data: S }, { type: 12, data: T }, { type: 12, data: I }, { type: 12, data: A }, { type: 12, data: E }, { type: 6, data: z }, { type: 12, data: g }, { type: 12, data: d }, { type: 12, data: c }, ...W(t[0].dims, t[1].dims)];
      n && (v.push(...W(t[2].dims)), $.push("rank")), v.push(...W(o));
      let R = (N) => {
        let j = [{ name: "output_size", type: "u32" }, { name: "strides", type: "u32", length: T.length }, { name: "filter_dims", type: "u32", length: I.length }, { name: "dilations", type: "u32", length: I.length }, { name: "effective_filter_dims", type: "u32", length: E.length }, { name: "pads", type: "i32", length: z.length }, { name: "input_channels_per_group_int", type: "u32" }, { name: "input_channels_per_group", type: "u32" }, { name: "output_channels_per_group", type: "u32" }], q = we(t[0].dataType), X = i ? 1 : 2, D = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t[1].dataType, t[1].dims.length, _), Y = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [Y, Q];
  ...
  var Hd = V(() => {
    ...
    Zh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, Qh = (t, e, r, n, o) => {
      ...
      for (let b = 0, _ = t.length - p - (u ? 1 : 0); b < p; ++b, ++_) {
        let S = t[_], x = m ? S * s[b] : c[b], $ = Zh(S, s[b], i[b], e[_], r[b], x);
        Qh($, n, i, b, b + p), m && c.push(s[b] * (S - 1) + d[b] + (e[_] - 1) * r[b] + 1 - i[b] - i[b + p]);
      }
  ...
  var Kd = V(() => {
    ...
    eg = (t, e, r, n) => {
      let o = k.size(e), i = e.length, s = O("input", t, i), u = U("output", t, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = k.normalizeAxis(d, i), p = (m) => {
        let g = ` i32(${s.indicesGet("inputIndices", "uniforms.axis")}) `, y = K("uniforms.input_shape", "uniforms.axis", i), b = n.reverse ? g + (n.exclusive ? " + 1" : "") : "0", _ = n.reverse ? y : g + (n.exclusive ? "" : " + 1");
        return `
...
`);
      ...
      let m = t.reshape(s), g = m.dims.length, y = t.dataType, b = O("a", y, g), _ = U("output", y, g), S = (x) => `
  ...
  ${x.mainStart()}
    ...
    ${_.setByOffset("global_idx", b.getByIndices("aIndices"))}
      ...
      return { name: "DepthToSpace", shaderCache: { hint: `${t.dims};${e.blocksize};${e.mode}`, inputDependencies: ["rank"] }, getRunData: (x) => {
        let $ = d ? [r, n * c, o * c, i / c ** 2] : [r, i / c ** 2, n * c, o * c], T = k.size($), I = m.dims, A = k.sortBasedOnPerm(I, u);
        return { outputs: [{ dims: $, dataType: x[0].dataType }], dispatchGroup: { x: Math.ceil(T / 64) }, programUniforms: [{ type: 12, data: T }, ...W(I, A)] };
      }, getShaderSource: S };
    }, jd = (t, e) => {
  ...
  var tl = V(() => {
    ...
    Co = "[a-zA-Z]|\\.\\.\\.", dn = "(" + Co + ")+", Yd = "^" + dn + "$", og = "(" + dn + ",)*" + dn, ig = "^" + og + "$", Ao = class {
      ...
      let i = t.map((p) => p.length).map((p, m) => O(`input${m}`, e, p)), s = k.size(n), u = U("output", e, n.length), d = [...r.symbolToInfo.keys()].filter((p) => !r.rhs.symbolToIndices.has(p)), c = (p) => {
        let m = [], g = "var prod = 1.0;", y = "var sum = 0.0;", b = "sum += prod;", _ = [], S = [], x = [], $ = [], T = r.symbolToInfo.size === r.rhs.symbolToIndices.size;
        r.symbolToInfo.forEach((A, E) => {
          if (r.rhs.symbolToIndices.has(E)) {
            let z = r.rhs.symbolToIndices.get(E)?.[0];
            z !== void 0 && r.lhs.forEach((v, R) => {
              if (A.inputIndices.includes(R)) {
                let N = v.symbolToIndices.get(E);
                if (N === void 0) throw new Error("Invalid symbol error");
                N.forEach((j) => {
                  m.push(`${i[R].indicesSet(`input${R}Indices`, j, u.indicesGet("outputIndices", z))}`);
                });
              }
            });
          } else r.lhs.forEach((z, v) => {
            if (A.inputIndices.includes(v)) {
              let R = z.symbolToIndices.get(E);
              if (R === void 0) throw new Error("Invalid symbol error");
              R.forEach((N) => {
                _.push(`${i[v].indicesSet(`input${v}Indices`, N, `${E}`)}`);
              }), $.push(`prod *= ${i[v].getByIndices(`input${v}Indices`)};`);
            }
          }), S.push(`for(var ${E}: u32 = 0; ${E} < uniforms.${Xd(E)}; ${E}++) {`), x.push("}");
        });
        let I = T ? [...m, `let sum = ${i.map((A, E) => A.getByIndices(`input${E}Indices`)).join(" * ")};`] : [...m, y, ...S, ..._, g, ...$, b, ...x];
        return `
...
`)};
  ...
  var dl = V(() => {
    ...
    cg = (t) => {
      ...
      let u = r[i], d = t[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(s) / d), p = [{ type: 12, data: c }, { type: 6, data: u }, { type: 12, data: i }, ...W(t[0].dims, t[1].dims, s)], m = (g) => {
        let y = O("data", t[0].dataType, t[0].dims.length, d), b = O("inputIndices", t[1].dataType, t[1].dims.length), _ = U("output", t[0].dataType, s.length, d), S = ($) => {
          let T = n.length, I = `var indicesIndices${$}  = ${b.type.indices}(0);`;
          for (let A = 0; A < T; A++) I += `${T > 1 ? `indicesIndices${$}[${A}]` : `indicesIndices${$}`} = ${s.length > 1 ? `outputIndices${$}[uniforms.axis + ${A}]` : `outputIndices${$}`};`;
          I += `
        ...
        `;
          for (let A = 0, E = 0; A < o; A++) A === i ? (I += `${o > 1 ? `dataIndices${$}[${A}]` : `dataIndices${$}`} = u32(idx${$});`, E += T) : (I += `${o > 1 ? `dataIndices${$}[${A}]` : `dataIndices${$}`} = ${s.length > 1 ? `outputIndices${$}[${E}]` : `outputIndices${$}`};`, E++);
          return I;
        }, x;
        if (t[0].dataType === 9) {
          let $ = (T, I, A = "") => `
  ...
  ${g.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
      ...
      let S = i.slice(0, -1).concat(n.slice(_)), x = k.size(S), $ = [{ type: 12, data: x }, { type: 12, data: d }, ...W(r[0].dims, b.dims, S)], T = (I) => {
        let A = O("data", r[0].dataType, r[0].dims.length), E = O("slice_offsets", 12, b.dims.length), z = U("output", r[0].dataType, S.length);
        return `
      ...
      t.compute({ name: "GatherND", shaderCache: { hint: e.cacheKey, inputDependencies: ["rank", "rank"] }, getRunData: () => ({ outputs: [{ dims: S, dataType: o }], dispatchGroup: { x: Math.ceil(x / 64) }, programUniforms: $ }), getShaderSource: T }, { inputs: [r[0], b] });
  ...
  var hl = V(() => {
    ...
    fg = (t, e) => {
      ...
      let d = k.size(u), c = t[2].dataType, m = t[0].dataType === 22, g = [{ type: 12, data: d }, { type: 12, data: s }, { type: 12, data: i }, { type: 12, data: e.blockSize }, ...W(...t.map((b, _) => b.dims), u)], y = (b) => {
        let _ = O("data", t[0].dataType, t[0].dims.length), S = O("inputIndices", t[1].dataType, t[1].dims.length), x = O("scales", t[2].dataType, t[2].dims.length), $ = t.length > 3 ? O("zeroPoint", t[3].dataType, t[3].dims.length) : void 0, T = U("output", c, u.length), I = [_, S, x];
        $ && I.push($);
  ...
  var vl = V(() => {
    ...
    yg = (t) => {
      ...
      let _ = (x) => {
        ...
        let T = e.alpha === 1 ? "" : "value *= uniforms.alpha;", I = O("a", t[0].dataType, t[0].dims), A = O("b", t[1].dataType, t[1].dims), E = I.type.value, z = null, v = [I, A];
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = value;
        ...
        let $ = O("a", t[0].dataType, t[0].dims), T = O("b", t[1].dataType, t[1].dims), I = null, A = [$, T];
        t.length === 3 && (I = O("c", t[2].dataType, t[2].dims.length), A.push(I));
        let E = U("output", t[0].dataType, u.length);
        A.push(E);
...
`, Ig = (t, e, r) => (() => {
  ...
  var ko = V(() => {
    ...
    Ue = (t, e) => t.length > e && t[e].dims.length > 0 ? t[e] : void 0, kg = (t, e) => {
      ...
      let p = r.dims[0], m = r.dims[1], g = r.dims.length === 3 ? r.dims[2] : e.numHeads * r.dims[4], y = m, b = 0, _ = 0, S = Math.floor(g / e.numHeads);
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
      ...
      let y = ar(t, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, s, r.hiddenSize), b = ar(t, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, s, 2 * r.hiddenSize);
      Wt(t, g, y, b, u, void 0, c, p, d, r);
    };
  });
  var Og;
  var zg;
...
`)}
  ...
  var zo = V(() => {
    ...
    Mg = (t, e) => {
      ...
      let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = e, s = t[0].dims[0], u = k.sizeFromDimension(t[0].dims, 1), d = t[0].dims[t[0].dims.length - 2], c = u / d, p = t[2].dims[1], m = o === 0 ? p * 2 : c / n, g = new Array(s, d, c / m, m - p), y = k.computeStrides(g), b = [{ type: 1, data: i }, { type: 12, data: g }, { type: 12, data: y }, ...t[0].dims.length === 3 ? new Array({ type: 12, data: [u, c, m, 1] }) : [], ...t[0].dims.length === 4 ? new Array({ type: 12, data: [u, m, d * m, 1] }) : [], ...W(t[0].dims, t[1].dims, t[2].dims, t[3].dims, t[0].dims)], _ = (S) => {
        let x = O("input", t[0].dataType, t[0].dims.length), $ = O("position_ids", t[1].dataType, t[1].dims.length), T = O("cos_cache", t[2].dataType, t[2].dims.length), I = O("sin_cache", t[3].dataType, t[3].dims.length), A = U("output", t[0].dataType, t[0].dims.length);
        return S.registerUniforms([{ name: "scale", type: "f32" }, { name: "global_shape", type: "u32", length: g.length }, { name: "global_strides", type: "u32", length: y.length }, { name: "input_output_strides", type: "u32", length: y.length }]), `
  ...
  var zl = V(() => {
    ...
    Rg = (t, e) => {
      ...
      y && (p = b * e.numHeads);
      let _ = i && i.dims.length !== 0, S = s && s.dims.length !== 0;
      ...
      let T = 0, I = false, A = e.kvNumHeads ? b * e.kvNumHeads : p;
      ...
      let E = t.length > 4 ? t[5] : void 0;
      if (E && E.dims.length !== 1 && E.dims[0] !== d) throw new Error('Input "seqlens" is expected to have 1 dimension and the same dim 0 as batch_size');
  ...
  `;
      ...
      let n = t.inputs[0], o = t.inputs[1] && t.inputs[1].dims.length > 0 ? t.inputs[1] : void 0, i = t.inputs[2] && t.inputs[2].dims.length > 0 ? t.inputs[2] : void 0, s = t.inputs[3] && t.inputs[3].dims.length !== 0 ? t.inputs[3] : void 0, u = t.inputs[4] && t.inputs[4].dims.length !== 0 ? t.inputs[4] : void 0, d = t.inputs.length > 4 ? t.inputs[5] : void 0, c = t.inputs.length > 5 ? t.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = ee({ axis: 2, numOutputs: 3, splitSizes: [r.numHeads * r.headSize, p * r.headSize, p * r.headSize] }), [g, y, b] = !o && !i ? t.compute(Po([n], m), { inputs: [n], outputs: [-1, -1, -1] }) : [n, o, i], _, S;
      if (e.doRotary) {
        let I = t.compute(Ng(r.batchSize, r.sequenceLength, d, c), { inputs: [d, c], outputs: [-1] })[0], A = t.inputs[7], E = t.inputs[8], z = ee({ interleaved: e.rotaryInterleaved !== 0, numHeads: r.numHeads, rotaryEmbeddingDim: 0, scale: e.scale }), v = [g, I, A, E], R = [-1];
        ...
        S = t.compute(ln(v, N), { inputs: v, outputs: R })[0];
      }
      let x = ar(t, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, e.doRotary ? _ : g, void 0, 0), $ = Pl(t, e.doRotary ? S : y, r), T = Pl(t, b, r);
  ...
  var Ml = V(() => {
    ...
    Dl = (t, e, r, n, o, i, s, u) => {
      ...
      m === 1 && (g = 256);
      let y = [o, s, i / d], b = [o, s, 2], _ = ["rank", "type", "type"], S = [];
      S.push(...W(y, b));
      let x = ($) => {
        let T = O("x", e.dataType, 3, d), I = O("scale", r.dataType, r.dims), A = O("bias", n.dataType, n.dims), E = U("output", 1, 3, 2), z = [T, I, A, E];
        return `
  ...
  ${$.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      return t.compute({ name: "InstanceNormComputeChannelScaleShift", shaderCache: { hint: `${d};${u};${g}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: b, dataType: 1 }], dispatchGroup: { x: m }, programUniforms: S }), getShaderSource: x }, { inputs: [e, r, n], outputs: [-1] })[0];
    }, Vg = (t, e, r) => {
      let n = e[0].dims, o = n, i = 2, s = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = Dl(t, e[0], e[1], e[2], s, d, u, r.epsilon), g = [s, u, d / c], y = [s, u], b = ["type", "none"], _ = (S) => {
        let x = O("x", e[0].dataType, g.length, c), $ = O("scale_shift", 1, y.length, 2), T = U("output", e[0].dataType, g.length, c), I = [x, $, T];
        return `
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      g = g && n[n.length - 1] !== 1;
      let b = g ? t.compute(De(t.inputs[0], y), { inputs: [t.inputs[0]], outputs: [-1] })[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[y[$]])), _ = Dl(t, b, e[1], e[2], i, u, s, r.epsilon), S = (x) => {
        let $ = we(e[0].dataType), T = d === 1 ? "vec2f" : `mat${d}x2f`, I = (z) => {
        ...
        }, A = O("input", e[0].dataType, e[0].dims, d), E = U("output", e[0].dataType, o, d);
        return `
  ...
  ${x.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${I(0)}, ${I(1)});
      ...
      t.compute({ name: "InstanceNormalizationNHWC", shaderCache: { hint: `${d}`, inputDependencies: m }, getRunData: () => ({ outputs: [{ dims: o, dataType: e[0].dataType }], dispatchGroup: { x: Math.ceil(c / 64) }, programUniforms: p }), getShaderSource: S }, { inputs: [e[0], _] });
    }, Bl = (t, e) => {
  ...
  var Ul = V(() => {
    ...
    Wg = (t) => {
      ...
      let y = [];
      for (let A = 0; A < o.length; ++A) A < d ? y.push(o[A]) : y.push(1);
      let b = fe(p), _ = ["type", "type"], S = [{ type: 12, data: c }, { type: 1, data: p }, { type: 12, data: Math.floor(p / b) }, { type: 1, data: e.epsilon }];
      s && _.push("type");
      let x = r > 1, $ = r > 2, T = (A) => {
        let E = we(t[0].dataType), z = [O("x", t[0].dataType, t[0].dims, b), O("scale", i.dataType, i.dims, b)];
  ...
  ${A.mainStart()}
    ...
    ${$ ? "inv_std_output[global_idx] = inv_std_dev" : ""};
      ...
      return x && I.push({ dims: y, dataType: 1 }), $ && I.push({ dims: y, dataType: 1 }), { name: "LayerNormalization", shaderCache: { hint: `${b};${r};${n}`, inputDependencies: _ }, getRunData: () => ({ outputs: I, dispatchGroup: { x: Math.ceil(c / 64) }, programUniforms: S }), getShaderSource: T };
    }, Rl = (t, e) => {
  ...
  var Gl = V(() => {
    ...
    Fg = (t, e) => {
      ...
      let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = fe(s), _ = u.concat([o, s]), S = o > 1 && s / b % 2 === 0 ? 2 : 1, x = k.size(_) / b / S, $ = 64, T = [], I = [d, o, i / g], A = k.convertShape(t[1].dims).slice();
      A.splice(-1, 1, p / y), T.push(...W(I)), T.push(...W(A)), T.push(...W(t[2].dims)), t.length === 4 && T.push(...W(k.convertShape(t[3].dims)));
      let E = [d, o, s / b];
      T.push(...W(E));
      let z = (v) => {
        let R = I.length, N = O("a", t[0].dataType, R, g), j = O("b", 12, A.length, y), q = O("scales", t[2].dataType, t[2].dims.length), X = [N, j, q], D = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
        D && X.push(D);
        let L = E.length, Q = U("output", t[0].dataType, L, b), Y = we(t[0].dataType), Z = (() => {
          switch (g) {
            case 1:
              return `array<${Y}, 8>`;
            case 2:
      ...
      return { name: "MatMulNBits", shaderCache: { hint: `${e.blockSize};${e.bits};${g};${y};${b};${S};${$}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: _, dataType: m }], dispatchGroup: { x }, programUniforms: T }), getShaderSource: z };
    }, Kg = (t, e) => {
      let r = t[0].dims, n = r.length, o = r[n - 2], i = e.k, s = e.n, u = r.slice(0, n - 2), d = k.size(u), p = t[1].dims[2] / 4, m = t[0].dataType, g = fe(e.k), y = fe(p), b = u.concat([o, s]), _ = 128, S = s % 8 === 0 ? 8 : s % 4 === 0 ? 4 : 1, x = _ / S, $ = Math.floor(32 / e.bits), T = x * y * $, I = T / g, A = T / e.blockSize, E = k.size(b) / S, z = [], v = [d, o, i / g], R = k.convertShape(t[1].dims).slice();
      ...
      return { name: "BlockwiseMatMulNBits32", shaderCache: { hint: `${e.blockSize};${g};${y};${x};${S}`, inputDependencies: Array(t.length).fill("rank") }, getRunData: () => ({ outputs: [{ dims: b, dataType: m }], dispatchGroup: { x: E }, programUniforms: z }), getShaderSource: j };
    }, Ll = (t, e) => {
  ...
  var uc = V(() => {
    ...
    cn = (t) => {
      ...
      if (e.kernelShape.length <= 2) {
        ...
        let g = false;
        if (e.kernelShape.length === 2) {
          let y = e.kernelShape[e.kernelShape.length - 2], b = e.strides[e.strides.length - 2], _ = e.pads[e.pads.length / 2 - 2], S = e.pads[e.pads.length - 2];
          g = !!(_ + S), i.push({ type: 12, data: y }, { type: 12, data: b }, { type: 12, data: _ }, { type: 12, data: S }), s.push({ name: "kh", type: "u32" }, { name: "sh", type: "u32" }, { name: "phStart", type: "u32" }, { name: "phEnd", type: "u32" });
        }
        return [i, s, true, m, g];
      } else {
      ...
      if (o.kernelShape.length <= 2) {
        ...
        let _ = o.kernelShape.length, S = o.pads.length, x = "";
        return c ? x = `
      ...
      p.push(...W(e.dims, i));
      let _ = ["rank"];
      return { name: t, shaderCache: { hint: `${n.cacheKey};${g};${y};${b}`, inputDependencies: _ }, getRunData: () => ({ outputs: [{ dims: i, dataType: e.dataType }], dispatchGroup: { x: Math.ceil(k.size(i) / 64) }, programUniforms: p }), getShaderSource: (S) => jl(S, s, e.dims.length, i.length, o, d, c, 0, m, g, y, b) };
    }, Xl = (t) => {
  ...
  var cc = V(() => {
    ...
    ib = (t, e) => {
      ...
      let r = k.normalizeAxis(e.axis, t[0].dims.length), n = t[0].dataType, o = n === 3, i = t[0].dims, s = t[1].dataType, u = k.size(i), d = n === 3 || n === 2, c = d ? [Math.ceil(k.size(t[0].dims) / 4)] : t[0].dims, p = t[1].dims, m = t.length > 2 ? t[2] : void 0, g = m ? d ? [Math.ceil(k.size(m.dims) / 4)] : m.dims : void 0, y = p.length === 0 || p.length === 1 && p[0] === 1, b = y === false && p.length === 1, _ = fe(u), S = y && (!d || _ === 4), x = S ? _ : 1, $ = S && !d ? _ : 1, T = O("input", d ? 12 : n, c.length, $), I = O("scale", s, p.length), A = m ? O("zero_point", d ? 12 : n, g.length) : void 0, E = U("output", s, i.length, x), z = [T, I];
      A && z.push(A);
      let v = [c, p];
      m && v.push(g);
      let R = [{ type: 12, data: u / x }, { type: 12, data: r }, { type: 12, data: e.blockSize }, ...W(...v, i)], N = (j) => {
      ...
      return { name: "DequantizeLinear", shaderCache: { hint: e.cacheKey, inputDependencies: A ? ["rank", "rank", "rank"] : ["rank", "rank"] }, getShaderSource: N, getRunData: () => ({ outputs: [{ dims: i, dataType: s }], dispatchGroup: { x: Math.ceil(u / x / 64), y: 1, z: 1 }, programUniforms: R }) };
    }, dc = (t, e) => {
...
` : "", $b = (t, e, r, n, o) => {
    ...
    fn bilinearInterpolation(output_indices: ${e.type.indices}) -> ${p} {
      ...
      let p = r.length === 2, m = true, [g, y] = p ? [0, 1] : m ? [2, 3] : [1, 2], b = t.type.value, _ = (S) => {
        let x = S === g ? "row" : "col";
        return `
  ...
  fn bicubicInterpolation(output_indices: ${e.type.indices}) -> ${b} {
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      n.length === 0 && (c = s.map(($, T) => $ === 0 ? 1 : d[T] / $), e.keepAspectRatioPolicy !== "stretch" && (d = yb(s, c, e)));
      let p = U("output", t.dataType, d.length), m = O("input", t.dataType, s.length), g = k.size(d), y = s.length === d.length && s.every(($, T) => $ === d[T]), b = e.coordinateTransformMode === "tf_crop_and_resize", _ = e.extrapolationValue, S = m.type.value, x = ($) => `
      ${y ? "" : `
...
`}
  ...
  var xc = V(() => {
    ...
    Cb = (t) => {
      ...
      let o = e.simplified, i = t[0].dims, s = k.size(i), u = i, d = s, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && t.length > 3, g = t.length > 4, y = n && r > 1, b = n && r > 2, _ = r > 3, S = 64, x = fe(c), $ = [{ type: 12, data: d }, { type: 12, data: x }, { type: 12, data: c }, { type: 1, data: e.epsilon }], T = (A) => {
        let E = [{ name: "output_size", type: "u32" }, { name: "components", type: "u32" }, { name: "hidden_size", type: "u32" }, { name: "epsilon", type: "f32" }], z = [O("x", t[0].dataType, t[0].dims, x), O("skip", t[1].dataType, t[1].dims, x), O("gamma", t[2].dataType, t[2].dims, x)];
      ...
      return r > 1 && I.push({ dims: p, dataType: 1 }), r > 2 && I.push({ dims: p, dataType: 1 }), r > 3 && I.push({ dims: i, dataType: t[0].dataType }), { name: "SkipLayerNormalization", shaderCache: { hint: `${x};${y};${b};${_}`, inputDependencies: t.map((A, E) => "type") }, getShaderSource: T, getRunData: () => ({ outputs: I, dispatchGroup: { x: Math.ceil(d / c) }, programUniforms: $ }) };
    }, $c = (t, e) => {
      Cb(t.inputs);
      let n = [0];
  ...
  var Cc = V(() => {
    ...
    Eb = (t, e) => {
      ...
      return { name: "Slice", shaderCache: { hint: `${d.length}_${s.length}_${i.length}`, inputDependencies: ["rank"] }, getShaderSource: S, getRunData: () => ({ outputs: [p], dispatchGroup: { x: Math.ceil(n / 64) }, programUniforms: _ }) };
    }, Tc = (t, e) => {
      Eb(t.inputs, e);
      let r = kb(t.inputs, e);
  ...
  var kc = V(() => {
    ...
    zb = (t) => {
      ...
      g === 1 && (_ = 256);
      let S = (z, v) => v === 4 ? `max(max(${z}.x, ${z}.y), max(${z}.z, ${z}.w))` : v === 2 ? `max(${z}.x, ${z}.y)` : v === 3 ? `max(max(${z}.x, ${z}.y), ${z}.z)` : z, x = O("x", d.dataType, d.dims, y), $ = U("result", d.dataType, d.dims, y), T = x.type.value, I = we(d.dataType) === "f32" ? `var threadMax = ${T}(-3.4028234663852886e+38f);` : `var threadMax = ${T}(-65504.0h);`, A = (z) => `
      ...
      }`, E = t.compute({ name: "Softmax", shaderCache: { hint: `${y};${_}`, inputDependencies: ["type"] }, getRunData: () => ({ outputs: [{ dims: p, dataType: d.dataType }], dispatchGroup: { x: g }, programUniforms: [{ type: 6, data: b }] }), getShaderSource: A }, { inputs: [d], outputs: [u ? -1 : 0] })[0];
      u && t.compute(De(E, c), { inputs: [E] });
    }, Ac = (t, e) => {
      zb(t.inputs), Db(t, e);
    }, Ec = (t) => ee({ axis: t.axis });
  });
  ...
  var Bc = V(() => {
    ...
    Ub = (t, e, r, n, o) => {
      ...
      if (!n) c = i.setByOffset("global_idx", p(s.getByOffset("global_idx"), u.getByOffset("global_idx"), d.getByOffset("global_idx")));
        ...
        let m = (g, y, b = "") => {
          let _ = `a_data[index_a${y}][component_a${y}]`, S = `b_data[index_b${y}][component_b${y}]`, x = `bool(c_data[index_c${y}] & (0xffu << (component_c${y} * 8)))`;
          return `
...
${u}`, c = n.createShaderModule({ code: d, label: e.name });
    ...
    Vb = (t, e) => {
      ...
      flush() {
        ...
        this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), e = this.device.createBuffer({ size: this.pendingDispatchNumber * 2 * 8, usage: GPUBufferUsage.MAP_READ | GPUBufferUsage.COPY_DST }), this.pendingQueries.set(e, this.pendingKernels), this.pendingKernels = [], this.commandEncoder.copyBufferToBuffer(this.queryResolveBuffer, 0, e, 0, this.pendingDispatchNumber * 2 * 8)), this.device.queue.submit([this.commandEncoder.finish()]), this.gpuDataManager.refreshPendingBuffers(), this.commandEncoder = null, this.pendingDispatchNumber = 0, this.queryType !== "none" && e.mapAsync(GPUMapMode.READ).then(() => {
          ...
          for (let o = 0; o < r.length / 2; o++) {
            ...
            let _ = Number(y - this.queryTimeBase), S = Number(b - this.queryTimeBase);
            if (!Number.isSafeInteger(_) || !Number.isSafeInteger(S)) throw new RangeError("incorrect timestamp range");
            if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({ version: 1, inputsMetadata: m.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), outputsMetadata: g.map((x) => ({ dims: x.dims, dataType: rt(x.dataType) })), kernelId: s, kernelType: d, kernelName: c, programName: p, startTime: _, endTime: S });
            else {
              let x = "";
              m.forEach((T, I) => {
              ...
              }), console.log(`[profiling] kernel "${s}|${d}|${c}|${p}" ${x}${$}start time: ${_} ns, execution time: ${S - _} ns`);
            }
            Sr("GPU", `${p}::${y}::${b}`);
          }
      ...
      run(e, r, n, o, i, s) {
        ...
        for (let T = 0; T < r.length; ++T) {
          let I = r[T].data;
          if (I === 0) continue;
          let A = this.gpuDataManager.get(I);
          if (!A) throw new Error(`no GPU data for input: ${I}`);
          u.push(A);
        }
        ...
        for (let T = 0; T < d.length; ++T) {
          ...
          if (m[T] === -3) continue;
          let I = m[T] === -1, A = m[T] === -2, E = I || A ? i(d[T].dataType, d[T].dims) : o(m[T], d[T].dataType, d[T].dims);
          if (g.push(E), E.data === 0) continue;
          let z = this.gpuDataManager.get(E.data);
          if (!z) throw new Error(`no GPU data for output: ${E.data}`);
          if (I && this.temporaryData.push(z), A) {
        ...
        if (p) {
          ...
          p.forEach((v) => {
            ...
            let N = v.type === 10 ? 2 : 4, j, q;
            v.type === 10 ? (q = R.length > 4 ? 16 : R.length > 2 ? 8 : R.length * N, j = R.length > 4 ? 16 : N * R.length) : (q = R.length <= 2 ? R.length * N : 16, j = 16), T = Math.ceil(T / q) * q, I.push(T);
            let X = v.type === 10 ? 8 : 4;
            T += R.length > 4 ? Math.ceil(R.length / X) * j : R.length * N;
          });
          let A = 16;
          T = Math.ceil(T / A) * A;
          let E = new ArrayBuffer(T);
          p.forEach((v, R) => {
            let N = I[R], j = typeof v.data == "number" ? [v.data] : v.data;
            if (v.type === 6) new Int32Array(E, N, j.length).set(j);
            else if (v.type === 12) new Uint32Array(E, N, j.length).set(j);
            else if (v.type === 10) new Uint16Array(E, N, j.length).set(j);
            else if (v.type === 1) new Float32Array(E, N, j.length).set(j);
          ...
          this.device.queue.writeBuffer(z.buffer, 0, E, 0, T), this.gpuDataManager.release(z.id), b = { offset: 0, size: T, buffer: z.buffer };
        }
        let _ = this.programManager.normalizeDispatchGroupSize(c), S = _[1] === 1 && _[2] === 1, x = Lb(e, r, S), $ = this.programManager.getArtifact(x);
        if ($ || ($ = this.programManager.build(e, _), this.programManager.setArtifact(x, $), ie("info", () => `[artifact] key: ${x}, programName: ${e.name}`)), p && $.uniformVariablesInfo) {
          ...
          for (let T = 0; T < p.length; T++) {
            let I = p[T], A = I.type, E = typeof I.data == "number" ? 1 : I.data.length, [z, v] = $.uniformVariablesInfo[T];
            if (A !== z || E !== v) throw new Error(`Uniform variable ${T} mismatch: expect type ${z} with size ${v}, got type ${A} with size ${E} in program "${$.programInfo.name}".`);
          }
        }
  ...
  var Wc = V(() => {
    ...
    sr = class t {
      ...
      if (t === "webgpu") {
        let i = (Vc(), Yt(Nc)).WebGpuBackend, s = new i();
  ...
  var Qn = V(() => {
    ...
    Gb = (t, e) => {
      ...
      Gb(t.wasm.numThreads, tr(t.logLevel));
    }, kr = async (t, e) => {
      ye().asyncInit?.();
      ...
      try {
        if ([s, d] = await Ss(e), e?.externalData && o.mountExternalData) {
          ...
          for (let A of e.externalData) {
            let E = typeof A == "string" ? A : A.path;
            I.push(rr(typeof A == "string" ? A : A.data).then((z) => {
              o.mountExternalData(E, z);
            }));
          }
          await Promise.all(I);
        }
        for (let I of e?.executionProviders ?? []) if ((typeof I == "string" ? I : I.name) === "webnn") {
          if (o.shouldTransferToMLTensor = false, typeof I != "string") {
            let E = I, z = E?.context, v = E?.gpuDevice, R = E?.deviceType, N = E?.powerPreference;
        ...
        let [m, g] = Hb(i), y = !!e?.enableGraphCapture, b = [], _ = [], S = [], x = [], $ = [];
        for (let I = 0; I < m; I++) {
          let [A, E, z] = Gc(i, I);
          A === 0 && me("Can't get an input name."), c.push(A);
          let v = o.UTF8ToString(A);
          b.push(v), S.push(E === 0 ? { name: v, isTensor: false } : { name: v, isTensor: true, type: rt(E), shape: z });
        }
        for (let I = 0; I < g; I++) {
          let [A, E, z] = Gc(i, I + m);
          A === 0 && me("Can't get an output name."), p.push(A);
          let v = o.UTF8ToString(A);
          _.push(v), x.push(E === 0 ? { name: v, isTensor: false } : { name: v, isTensor: true, type: rt(E), shape: z });
          {
        ...
        let T = null;
        return $.some((I) => I === "gpu-buffer" || I === "ml-tensor" || I === "ml-tensor-cpu-output") && (u = o._OrtCreateBinding(i), u === 0 && me("Can't create IO binding."), T = { handle: u, outputPreferredLocations: $, outputPreferredLocationsEncoded: $.map((I) => I === "ml-tensor-cpu-output" ? "ml-tensor" : I).map((I) => to(I)) }), Mt.set(i, [i, c, p, T, y, false]), [i, b, _, S, x];
      } catch (m) {
      ...
      if (m === "gpu-buffer") {
        ...
        if (Array.isArray(x)) {
          ...
          if (c !== "string" && $ && T) {
            ...
            if ($(n, I) || T(n, I)) {
              let A = $t(c);
              b = xt(A, p), g = "ml-tensor";
              let E = u.webnnCreateTemporaryTensor, z = u.webnnUploadTensor;
              if (!E || !z) throw new Error('Tensor location "ml-tensor" is not supported without using WebNN.');
              let v = await E(n, A, p);
      ...
      try {
        ...
        let x = u._OrtCreateTensor($t(c), y, b, S, p.length, to(g));
      ...
      let c = d[0], p = d[1], m = d[2], g = d[3], y = d[4], b = d[5], _ = e.length, S = n.length, x = 0, $ = [], T = [], I = [], A = [], E = [], z = s.stackSave(), v = s.stackAlloc(_ * u), R = s.stackAlloc(_ * u), N = s.stackAlloc(S * u), j = s.stackAlloc(S * u);
      try {
        [x, $] = $s(i), _t("wasm prepareInputOutputTensor");
        for (let L = 0; L < _; L++) await Hc(r[L], T, A, t, p[e[L]], e[L], y);
        for (let L = 0; L < S; L++) await Hc(o[L], I, A, t, m[n[L]], _ + n[L], y);
        wt("wasm prepareInputOutputTensor");
        for (let L = 0; L < _; L++) s.setValue(v + L * u, T[L], "*"), s.setValue(R + L * u, p[e[L]], "*");
        for (let L = 0; L < S; L++) s.setValue(N + L * u, I[L], "*"), s.setValue(j + L * u, m[n[L]], "*");
        if (g && !b) {
          ...
          for (let Z = 0; Z < _; Z++) {
            let te = e[Z];
            await s._OrtBindInput(L, p[te], T[Z]) !== 0 && me(`Can't bind input[${Z}] for session=${t}.`);
          }
          for (let Z = 0; Z < S; Z++) {
            let te = n[Z];
            o[Z]?.[3] ? (E.push(I[Z]), s._OrtBindOutput(L, m[te], I[Z], 0) !== 0 && me(`Can't bind pre-allocated output[${Z}] for session=${t}.`)) : s._OrtBindOutput(L, m[te], 0, Y[te]) !== 0 && me(`Can't bind output[${Z}] to ${Q[Z]} for session=${t}.`);
          }
          wt("wasm bindInputsOutputs"), Mt.set(t, [c, p, m, g, y, true]);
        }
        s.jsepOnRunStart?.(c), s.webnnOnRunStart?.(c);
        let q;
        g ? q = await s._OrtRunWithBinding(c, g.handle, S, N, x) : q = await s._OrtRun(c, R, v, _, j, S, N, x), q !== 0 && me("failed to call OrtRun().");
        let X = [], D = [];
        _t("wasm ProcessOutputTensor");
        for (let L = 0; L < S; L++) {
          let Q = Number(s.getValue(N + L * u, "*"));
          if (Q === I[L] || E.includes(I[L])) {
        ...
        s.webnnOnRunEnd?.(c), s.stackRestore(z), T.forEach((q) => s._OrtReleaseTensor(q)), I.forEach((q) => s._OrtReleaseTensor(q)), A.forEach((q) => s._free(q)), x !== 0 && s._OrtReleaseRunOptions(x), $.forEach((q) => s._free(q));
      }
    }, Dr = (t) => {
      let e = ye(), r = Mt.get(t);
  ...
  var No = V(() => {
    ...
    vt();
    Cr();
    Rt = () => !!_e.wasm.proxy && typeof document < "u", ur = false, hn = false, gn = false, Uo = /* @__PURE__ */ new Map(), Ft = (t, e) => {
      let r = Uo.get(t);
      r ? r.push(e) : Uo.set(t, [e]);
    }, qt = () => {
      if (ur || !hn || gn || !Fe) throw new Error("worker not ready");
    }, qb = (t) => {
      switch (t.data.type) {
        case "init-wasm":
      ...
      if (!hn) {
        ...
        if (ur = true, Rt()) return new Promise((t, e) => {
          Fe?.terminate(), _s().then(([r, n]) => {
            try {
              ...
              !o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("ort-wasm-simd-threaded.jsep.wasm", import_meta.url).href }), Fe.postMessage(o), fn = r;
            } catch (o) {
              e(o);
            }
          }, e);
        ...
        try {
          await Ar(_e.wasm), await Er(_e), hn = true;
        } catch (t) {
          throw gn = true, t;
        } finally {
          ur = false;
      ...
      await kr(_e, t);
    }, Kc = async (t) => Rt() ? (qt(), new Promise((e, r) => {
      Ft("copy-from", [e, r]);
  ...
  function makeInt64Tensor2D(rows) {
    ...
    for (let i = 0; i < batch; i += 1) {
      for (let j = 0; j < seq; j += 1) {
        data[k2] = BigInt(rows[i][j]);
        k2 += 1;
      }
    }
    return new je("int64", data, [batch, seq]);
  }
  function makeInt64Tensor1D(values) {
    ...
    return new je("int64", data, [values.length]);
  }
  ...
  var DEFAULT_MODEL_BASE_PATH = "./models/community";
  ...
  async function createLemmaTypePredictor({
    modelPath,
    vocabPath,
    labelsPath,
    maxDecodeLen,
    ...
    const idToCode = {};
    for (const [k2, v] of Object.entries(vocab.id_to_code)) {
      idToCode[Number(k2)] = v;
    }
    ...
    const session = await _f.create(modelPath, {
  ...
  async function createDerivativeTypePredictor({
    modelPath,
    vocabPath,
    maxDecodeLen,
    executionProviders
    ...
    const eosId = stoi[EOS];
    const unkId = stoi[UNK];
    if (padId === void 0 || bosId === void 0 || eosId === void 0 || unkId === void 0) {
    ...
    const inputNameSet = new Set(session.inputNames);
    const outputTokenName = session.outputNames.includes("token_logits") ? "token_logits" : session.outputNames[0];
    ...
    function encodeText(text, addBos = false, addEos = false) {
      ...
      for (const ch2 of text) ids.push(stoi[ch2] ?? unkId);
    ...
    async function predict(lemma, wordType, sentencePerson, sentenceMode, sentenceTense) {
      ...
      const normalizedMode = isNounOrAdje ? normalizeEnumToken(sentenceMode, "ALL") : normalizeEnumToken(sentenceMode, "NONE");
      const normalizedTense = isNounOrAdje ? normalizeEnumToken(sentenceTense, "ALL") : normalizeEnumToken(sentenceTense, "NONE");
  ...
  async function FrSpell(options = {}) {
    const {
    ...
    if (wasmPaths && _e && _e.wasm) {
      _e.wasm.wasmPaths = wasmPaths;
    }
